...
// export const captureTraceData: Implementation["actions"]["captureTraceData"] =
...
//       logger
//         .forBot()
//         .debug(`'Capture trace data' exception ${JSON.stringify(error)}`);
//     }
//     return {
//       success,
//     };
